...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      {/* 1. PREMIUM HEADER */}
      <section className="relative pt-40 pb-20 overflow-hidden border-b border-border/40 dark:border-white/5">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-left space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-border/30 dark:border-white/10 bg-foreground/5 dark:bg-white/5 backdrop-blur-xl">
              <span className="w-2 h-2 bg-primary rounded-full animate-pulse shadow-[0_0_10px_var(--primary)]" />
              <span className="text-[10px] font-black tracking-[0.3em] uppercase opacity-90 text-foreground/80 dark:text-white">
                {t("common.projects")}
              </span>
            </div>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-foreground dark:text-white leading-[0.85]">
