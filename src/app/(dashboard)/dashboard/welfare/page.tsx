      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
           <AFSectionTitle 
            ...
            className="mb-0"
          />
          <Card className="border border-amber-500/10 shadow-2xl rounded-3xl overflow-hidden bg-card backdrop-blur-md">
            <CardHeader className="p-6 border-b border-amber-200/20 bg-amber-500/5">
              <CardTitle className="text-sm font-black uppercase tracking-wider flex items-center gap-3 text-amber-600">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-normal text-muted-foreground normal-case tracking-normal mt-1">
                    {t("welfare.verificationProtocolDesc")}
                  </p>
                </div>
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-5">
              <div className="space-y-3">
                ...
                <Input
                  placeholder={t("welfare.signatoryNamePlaceholder")}
              ...
              <div className="space-y-3">
                ...
                <Input
                  placeholder={t("welfare.signatoryDesignationPlaceholder")}
                  className="rounded-xl border-2 border-muted/50 focus:border-amber-500/50 focus:ring-2 focus:ring-amber-500/20 h-12 bg-background font-medium transition-all"
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full h-14 bg-amber-600 hover:bg-amber-700 disabled:bg-muted text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 uppercase text-sm tracking-wider flex items-center justify-center gap-3 group"
                >
