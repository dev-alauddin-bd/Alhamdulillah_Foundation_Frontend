      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8 ">
        ...
        <div className="space-y-8">
           <AFSectionTitle 
            ...
            className="mb-0"
          />
          <Card className="border border-primary/10 shadow-2xl rounded-3xl overflow-hidden bg-card backdrop-blur-md">
            ...
            <CardContent className="p-6 space-y-5">
              ...
              <div className="pt-2">
                <Button
                  ...
                  className="w-full h-14 bg-primary hover:bg-primary/90 disabled:bg-muted text-primary-foreground font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 uppercase text-sm tracking-wider flex items-center justify-center gap-3 group"
                >
