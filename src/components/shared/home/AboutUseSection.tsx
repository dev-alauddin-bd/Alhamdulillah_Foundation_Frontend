      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
          ...
          <div className="relative mx-auto w-full max-w-sm sm:max-w-md md:max-w-none">
            <div className="aspect-square rounded-3xl overflow-hidden bg-gradient-to-tr from-primary/20 to-primary/5 border border-border flex items-center justify-center">
