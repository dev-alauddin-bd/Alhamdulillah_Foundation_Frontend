...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-mesh pt-24 pb-12 overflow-hidden border-t border-border/40">
          ...
          <div className="space-y-8">
            <Link href="/" className="inline-block group">
              <div className="flex items-center gap-3">
                ...
                <span className="font-black text-xl tracking-tighter text-foreground uppercase">{t("brand.name")}</span>
              </div>
            </Link>
