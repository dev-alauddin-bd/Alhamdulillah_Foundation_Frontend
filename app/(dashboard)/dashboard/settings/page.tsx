...
export default function SettingsPage() {
  ...
  const handleSendOTP = async () => {
    try {
      ...
      toast.success("আপনার ইমেইলে একটি ওটিপি পাঠানো হয়েছে।");
      setOtpSent(true);
    } catch (err) {
  ...
  const handlePasswordChange = async () => {
    ...
    try {
      ...
      toast.success("পাসওয়ার্ড সফলভাবে পরিবর্তন করা হয়েছে", { id: toastId });
      setNewPassword("");
      setConfirmPassword("");
      setOtpSent(false);
      setOtpCode("");
    } catch (err) {
      toast.error("ওটিপি কোড ভুল বা মেয়াদ শেষ হয়ে গেছে", { id: toastId });
    }
  };
                        ...
                        <div className="p-10 space-y-10">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div className="md:col-span-2 space-y-3">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">ঠিকানা</label>
                                ...
                                <div className="md:col-span-2 space-y-3">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">শহর / রাজ্য</label>
                    ...
                    <Card className="mt-10 border-none shadow-3xl rounded-[3rem] overflow-hidden bg-card/40 backdrop-blur-xl border border-muted/20">
                        ...
                        <div className="p-10 space-y-6">
                            <p className="text-xs font-medium text-muted-foreground leading-relaxed mb-6">
                                আপনার একাউন্ট বর্তমানে নিচের ডিভাইসগুলোতে লগইন করা আছে। আপনি চাইলে যেকোনো ডিভাইস থেকে লগআউট করতে পারেন।
                            </p>
                        ...
                        {!otpSent ? (
                            <div className="space-y-6 text-center">
                                <div className="p-10 bg-primary/5 rounded-[2.5rem] border border-primary/10">
                                    ...
                                    <h4 className="text-sm font-black uppercase tracking-widest text-primary mb-2">ইমেইল ভেরিফিকেশন</h4>
                                    <p className="text-xs font-medium text-muted-foreground leading-relaxed">
                                        আপনার নিবন্ধিত ইমেইল ({user?.email}) এ একটি ওটিপি কোড পাঠানো হবে।
                                    </p>
                                </div>
                                <Button 
                            ...
                            <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">ওটিপি কোড দিন</label>
                                    <Input 
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">নতুন পাসওয়ার্ড</label>
                                    <Input 
                                        type="password" 
                                        value={newPassword}
                                ...
                                <div className="space-y-3">
                                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em]">পাসওয়ার্ড নিশ্চিত করুন</label>
                                    <Input 
                                        type="password" 
                                ...
                                <div className="pt-6 flex gap-4">
                                    ...
                                    <Button 
                                        ...
                                        className="flex-[2] h-16 rounded-2xl bg-emerald-600 font-black uppercase text-[10px] tracking-widest"
                                    >
